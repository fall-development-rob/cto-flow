/**
 * Integration Tests for Teammate-Driven Agent Management System
 *
...
describe('Teammate-Driven Agent Management System - Integration Tests', () => {
  ...
  describe('1. Teammate Mode Toggle', () => {
    ...
    it('should support per-command override (--teammate-mode flag)', async () => {
      ...
      const baseConfig: TeammateConfig = {
        enabled: false,
        fallbackToMemory: true
      };
      ...
      const overrideConfig: TeammateConfig = {
        ...baseConfig,
        enabled: true,
  ...
  describe('6. Graceful Degradation', () => {
    ...
    it('should use standard memory coordination when teammate mode off', async () => {
      const disabledConfig: TeammateConfig = {
        enabled: false,
        fallbackToMemory: true
      };
