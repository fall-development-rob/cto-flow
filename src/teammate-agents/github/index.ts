 ...
 *
 * Exports all GitHub integration components for teammate-agents:
 * - EpicSyncService: Bidirectional sync between memory and GitHub issues
 * - GitHubProjectManager: GitHub Projects v2 management
 * - TeammateProjectBridge: Connects epics to projects for full lifecycle
...
} from './teammate-project-bridge.js';
